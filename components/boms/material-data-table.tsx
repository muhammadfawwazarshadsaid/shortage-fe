...
interface DataTableProps<TData extends BomMaterialItem, TValue> {
  columns: ColumnDef<TData, TValue>[];
  data: TData[];
}

export function MaterialDataTable<TData extends BomMaterialItem, TValue>({
  columns,
  data,
            ...
            <Input
              ...
              placeholder={
                filterChips.length === 0
                  ? "Cari (Material, Deskripsi, Part Ref...), lalu tekan Enter..."
                  : "Tambah filter..."
              }
              value={inputValue}
